...
export type TripStatus = 'scheduled' | 'boarding' | 'departed' | 'in_transit' | 'arrived' | 'completed' | 'cancelled' | 'delayed';
...
export type TripUpdateType = 'status_change' | 'delay' | 'cancellation' | 'gate_change' | 'departure' | 'arrival';
...
export type BookingStatus = 'pending' | 'confirmed' | 'cancelled' | 'refunded' | 'completed' | 'no_show';
...
export type LoyaltyHistoryType = 'earned' | 'spent' | 'expired' | 'refunded' | 'bonus';
...
export type SupportTicketCategory = 'booking' | 'payment' | 'technical' | 'complaint' | 'feedback' | 'other';
